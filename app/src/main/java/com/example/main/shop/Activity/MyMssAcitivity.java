    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mymsg.enqueue(new Callback<MyMsg>() {
            ...
            public void onResponse(Call<MyMsg> call, Response<MyMsg> response) {
                ...
                String s = msg.getMsg();
                List<MyMsg.InfoBean> info = msg.getInfo();
                if (code==101) {
                    progress.dismiss();
                    mData.addAll(info);
        ...
        final MssAdapter mssAdapter=new MssAdapter(this,mData);
        mListView.setAdapter(mssAdapter);
        boolean itemsCanFocus = mListView.getItemsCanFocus();
        Log.d(TAG, "mss: ................."+itemsCanFocus);
